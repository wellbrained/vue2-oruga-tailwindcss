...
<template>
  <div class="flex items-center flex-shrink-0 space-x-2">
    ...
    <div class="relative inline-flex items-center">
      <span class="ml-4 mr-2 text-white">Theme:</span>
      <o-dropdown
        v-model="selectedTheme"
        aria-role="list"
        position="bottom-right"
        @input="setTheme(selectedTheme.name)"
      >
        <o-button slot="trigger" variant="default">
          {{ selectedTheme.displayName }}
          <svg xmlns="http://www.w3.org/2000/svg" class="inline-flex w-5 h-5 ml-2 -mr-1" viewBox="0 0 20 20" fill="currentColor">
